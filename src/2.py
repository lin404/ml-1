...
def denoising(noisy_img_arr, hidden_image, const_list):
    loop = 50
...
avg_2 = denoising(noisy_img_arr_2, hidden_image_2, beta)
avg_3 = denoising(noisy_img_arr_3, hidden_image_3, beta)
